...
export const selectTriggerIconClassName = "-me-1 size-5 opacity-80"
    ...
    <SelectPrimitive.Portal {...portalProps}>
      ...
      >
        ...
        >
          ...
          >
            <ChevronUpIcon className="relative size-5" />
          </SelectPrimitive.ScrollUpArrow>
          ...
          >
            <ChevronDownIcon className="relative size-5" />
          </SelectPrimitive.ScrollDownArrow>
        </SelectPrimitive.Popup>
      </SelectPrimitive.Positioner>
...
export function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      className={cn(
        "grid min-h-8 cursor-default grid-cols-[1.25rem_1fr] items-center gap-2 rounded-sm py-1 ps-2 pe-4 text-base outline-none in-data-[side=none]:min-w-[calc(var(--anchor-width)+1.25rem)] data-highlighted:bg-accent data-highlighted:text-accent-foreground sm:min-h-7 sm:text-sm data-disabled:pointer-events-none data-disabled:opacity-64 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-5",
        className
      )}
