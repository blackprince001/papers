...
import { FileThumbnail } from "@/components/shadcn/file-thumbnail"
...
import { ScrollArea, ScrollAreaPrimitive } from "@/components/shadcn/scroll-area"
import {
  Select,
  SelectContent,
  SelectItem,
...
const LazyPDFViewer = React.lazy(() =>
  import("@/components/shadcn/pdf-viewer").then((mod) => ({
...
const LazyXlsxViewerPreview = React.lazy(() =>
  import("@/components/shadcn/xlsx-viewer").then((mod) => ({
