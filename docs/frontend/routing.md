...
| `/deep-research` | `pages/DeepResearch.tsx` | composer + live deep-research run with progress, evidence status, cancellation, reconnect/offline recovery, and follow-ups — see [/features/deep-research.md](/features/deep-research.md) |
| `/deep-research-archive` | `pages/DeepResearchArchive.tsx` | searchable, paginated research history with open/delete and normal paused-run resume |
